...
Pod::Spec.new do |s|
  ...
  if is_new_arch_enabled
    ...
    # RCTReactNativeFactory (the only consumer) exists only on RN >= 0.78; on older
    # RN this pod is absent and the code uses the NSObject fallback. SDC-32584.
    s.dependency "React-RCTAppDelegate" if is_factory_available
    ...
    # See note above: gate the dependency on RN >= 0.78. SDC-32584.
    s.dependency "React-RCTAppDelegate" if is_factory_available
